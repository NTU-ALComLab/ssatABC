...
void 
Pb_DistillCreatePio( Abc_Ntk_t * pNtkDist , Abc_Ntk_t * pNtk )
{
	Abc_Obj_t * pObj;
	int i;
...
void 
Pb_DistillCreateGate( Abc_Ntk_t * pNtkDist , Abc_Ntk_t * pNtk )
{
   Abc_Obj_t * pObj , * pObjAi;
	...
	{
		pObj->pData = Abc_AigAnd( pNtkDist->pManFunc , Abc_ObjChild0Data(pObj) , Abc_ObjChild1Data(pObj) );
		if ( pObj->dTemp != 0.0 ) {
...
void 
Pb_DistillFinalize( Abc_Ntk_t * pNtkDist , Abc_Ntk_t * pNtk )
{
	Abc_Obj_t * pObj;
	int i;
...
void
Pb_PrintDistNtk( Abc_Ntk_t * pNtk )
{
	Abc_Obj_t * pObj;
	int i;
	...
	Abc_NtkForEachPi( pNtk , pObj , i )
      printf( "Obj Id = %d , name = %s , prob = %f\n" , Abc_ObjId(pObj) , Abc_ObjName(pObj) , pObj->dTemp );
}
