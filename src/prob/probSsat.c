...
void
Pb_WriteSSAT( Abc_Ntk_t * pNtk , char * name , int numPo , int numExist , int fQdimacs )
{
   FILE * out;
	int  numVar , numCla;
...
void 
Pb_WriteQdimacsPrefix( FILE * out , Abc_Ntk_t * pNtk , int numPo , int numExist )
{
   Abc_Obj_t * pObj;
	int i;
...
void 
Pb_WriteSSATprefix( FILE * out , Abc_Ntk_t * pNtk , int numPo , int numExist )
{
   Abc_Obj_t * pObj;
	int i;
	...
	Abc_NtkForEachPi( pNtk , pObj , i ) 
	{
		if ( i < numExist )
	      ...
	      fprintf( out , "%d x%d R %f\n" , Abc_ObjId(pObj) , Abc_ObjId(pObj) , pObj->dTemp );
	}
	Abc_NtkForEachNode( pNtk , pObj , i )
	   fprintf( out , "%d x%d E\n" , Abc_ObjId(pObj) , Abc_ObjId(pObj) );
	Abc_NtkForEachPo( pNtk , pObj , i )
